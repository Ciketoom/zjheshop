<template>
	<div>
		<nav-header class="header_back"></nav-header>
		<div class="details">
			<div class="details_main">
				...
				<div class="details_con">
					<div class="details_img"><img :src="'/static/image/new/'+ newdetails.newImage"/></div>
					...
					<p class="details_comment">
						<i class="iconfont icon-pinglun" @click="openComment"></i>
					</p>
					...
					<div class="content_list">	
						...
						<div class="content_item" v-for="item in comment">
							<div class="content_info">
								<dl>
									<dt>
										<img :src="'/static/image/'+ item.commentAvatar"/>
									</dt>
									<dd>
									...
									<p class="content_zan" >
										...
										<i class="iconfont icon-thumbup-fill" :class="{zancheck:item.zanCheck=='1'}"  @click="editZan(item)"></i>
									</p>
								</dl>
							</div>
			...
			<!--<div class='popContainer' v-show="iconzan">
				<transition name="likeAddAnimate">
				   <i class="iconfont icon-love"></i>
				</transition>
			</div>-->
		</div>
		<nav-footer class="footer_back"></nav-footer>
	</div>
</template>
...
export default {
	...
	methods :{
		...
		editZan(item){
			...
			console.log(item.commentZan,item.zanCheck);
    		axios.post("/news/zanEdit",{
    			...
    			zanCheck:item.zanCheck,
    				...
    				let res = response.data;
    				//setTimeout((this.iconzan = false),5000)
    		})
    	},
    	editComment() {
